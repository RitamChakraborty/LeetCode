...
class Solution {
    ...
    private Set<Obstacle> obstacleSet = new HashSet<>();
    ...
    private void moveX(int units, int sign) {
        int temp = x + units * sign;

        while (x != temp) {
            if (obstacleSet.contains(new Obstacle(x + sign, y))) {
                break;
            }
    ...
    private void moveY(int units, int sign) {
        int temp = y + units * sign;

        while (y != temp) {
            if (obstacleSet.contains(new Obstacle(x, y + sign))) {
                break;
            }
